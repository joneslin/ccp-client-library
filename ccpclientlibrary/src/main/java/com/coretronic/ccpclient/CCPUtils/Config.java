...
public class Config {
    ...
    public static String REQUIRE_CCPSERVICE_VERSION = "1.8";
    public static String ccpserviceApkDownloadPath = "https://ftp.coretronic.com/dl/coretronicnote/ccpservice/ccpservice1.8.apk";
